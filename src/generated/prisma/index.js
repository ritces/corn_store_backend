...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/aabv/Documents/dev/projects/corn_store_backend/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/aabv/Documents/dev/projects/corn_store_backend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Purchase {\n  id        String   @id @default(cuid()) // Unique identifier for the purchase\n  email     String // Client's email address\n  createdAt DateTime @default(now()) // Timestamp of when the purchase was recorded\n\n  // Optional: Add other fields you might want to store persistently\n  // name      String?\n  // address   String?\n\n  @@index([email]) // Index email for faster lookups\n  @@map(\"purchases\") // Optional: Define the table name in the database\n}\n",
  "inlineSchemaHash": "8f08766aeeef425ee974898fb60006d2c9a64b4e86bfe48c1408599f97ed683e",
  "copyEngine": true
}
